...
const uint8_t gfx_palette[16][3] = { // DB16 (VGA optimized)
    {0x00, 0x00, 0x00}, // 0  black
    {0x30, 0x34, 0x6C}, // 1  dark blue
    {0x34, 0x64, 0x24}, // 2  dark green
    {0x84, 0x94, 0xA0}, // 3  slate grey
    {0x84, 0x4C, 0x30}, // 4  brown
    {0x44, 0x24, 0x34}, // 5  dark purple
    {0xD4, 0x7C, 0x2C}, // 6  orange
    {0x74, 0x70, 0x60}, // 7  grey
    {0x50, 0x4C, 0x50}, // 8  dark grey
    {0x58, 0x7C, 0xD0}, // 9  blue
    {0x6C, 0xAC, 0x2C}, // 10 green
    {0x6C, 0xC4, 0xCC}, // 11 light blue
    {0xD0, 0x48, 0x48}, // 12 red
    {0xD4, 0xAC, 0x98}, // 13 peach
    {0xDC, 0xD4, 0x60}, // 14 yellow
    {0xFC, 0xFC, 0xFC}, // 15 white
};

/*const uint8_t gfx_palette[16][3] = { // CGA
    {0x00, 0x00, 0x00}, // 0  black
