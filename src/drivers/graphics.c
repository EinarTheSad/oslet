...
const uint8_t gfx_palette[16][3] = { // DB16
    ...
    {0x30, 0x34, 0x6D}, // 1  blue
    {0x34, 0x65, 0x24}, // 2  green
    {0x85, 0x95, 0xA1}, // 3  cyan
    {0x85, 0x4C, 0x30}, // 4  brown
    {0x44, 0x24, 0x34}, // 5  magenta
    {0xD2, 0x7D, 0x2C}, // 6  light red
    {0x75, 0x71, 0x61}, // 7  light grey
    {0x4E, 0x4A, 0x4E}, // 8  dark grey
    {0x59, 0x7D, 0xCE}, // 9  light blue
    {0x6D, 0xAA, 0x2C}, // 10 light green
    {0x6D, 0xC2, 0xCA}, // 11 light cyan
    {0xD0, 0x46, 0x48}, // 12 red
    {0xD2, 0xAA, 0x99}, // 13 light magenta
